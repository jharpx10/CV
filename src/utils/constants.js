...
const laboralExperiences = [
 ...
 const languages = [  
    ...
    const courses = [  
        ...
        {name:"Arquitectura de computadores", imgSrc:arquitectureCourse, date:"2017"},
        {name:"Comunicaciones y laboratorio", imgSrc:communicationsCourse, date:"2018"},
        {name:"Pruebas de software", imgSrc:testCourse, date:"2022"}]

module.exports= { crypto,chess,beatles,development,physics,laboralExperiences,academicExperiences,hobbies,languages,courses}